...
from launch.launch_description_sources import PythonLaunchDescriptionSource #added gazebo
from launch.actions import IncludeLaunchDescription #added gazebo
...
def generate_launch_description():
    ...
    robot_desc=ParameterValue(Command(['xacro ',urdf]),value_type=str) #added
