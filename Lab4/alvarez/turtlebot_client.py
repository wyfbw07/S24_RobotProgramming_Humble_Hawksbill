...
class TurtleClient(Node):
    def __init__(self):
        ...
        #Parameter Lab 4 COlOR Feb 27, 2024 - Ruben
        self.declare_parameter('turtleColor', 'blue', ParameterDescriptor(description= 'turtleColor'))
        ...
        #Parameter Lab 4 COlOR Feb 28, 2024 - Ruben
        self.declare_parameter('penSize', 1, ParameterDescriptor(description= 'penSize'))
