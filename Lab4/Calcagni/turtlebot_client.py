...
# Import necessary parameters by Alessio on 2/26/24
...
class TurtleClient(Node):
    def __init__(self):
        ...
        ### Adding a turtle color parameter by Alessio on 2/26/24 ###
        self.declare_parameter('turtleColor', 'red', ParameterDescriptor(description= 'turtleColor'))
        ...
        ### Adding a pen size paramter by Alessio on 2/27/24 ###
        self.declare_parameter('penSize', 3, ParameterDescriptor(description= 'penSize'))
        penSize = self.get_parameter('penSize').value
